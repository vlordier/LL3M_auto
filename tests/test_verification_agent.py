...
from src.agents.verification import VerificationAgent, QualityMetrics, VerificationResult
from src.utils.types import AgentType, ExecutionResult, IssueType, SubTask, TaskType, WorkflowState
...
class TestVerificationAgent:
    ...
    def test_calculate_quality_score_perfect(self, verification_config):
        ...
        assert score == 11.5  # 10.0 base + 1.5 bonus
