...
class BlenderCodeValidator:
    ...
    SAFE_MODULES = {
        "bpy", "bmesh", "mathutils", "bpy_extras", "bl_ui",
        "math", "random", "time", "datetime", "json", "os.path"
    }
...
"""
    ...
    def generate_object_code(self, shape: str, name: str = "GeneratedObject", 
    ...
    def _extract_color_from_description(self, description: str) -> Optional[Tuple[float, float, float]]:
